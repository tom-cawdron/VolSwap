...
export const MULTIVERSE_MARKET_ABI = [
    ...
    outputs: [
      {
        components: [
          ...
          { name: "seedCollateral", type: "uint256" },
          { name: "seedHighTokens", type: "uint256" },
          { name: "seedLowTokens", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "roundId", type: "uint256" },
      { indexed: false, name: "seedCollateral", type: "uint256" },
      { indexed: false, name: "seedHighTokens", type: "uint256" },
      { indexed: false, name: "seedLowTokens", type: "uint256" },
    ],
    name: "RoundSeeded",
    type: "event",
  },
